    ...
    function mostrarImagenGrande() {
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="${imagenes[indiceImagenActua1]}" class="personalizada">
          </div>
          <div class="carousel-item">
            <img src="${imagenes[indiceImagenActua2]}" class="personalizada">
          </div>
          <div class="carousel-item">
            <img src="${imagenes[indiceImagenActua3]}" class="personalizada">
          </div>
        </div> 
